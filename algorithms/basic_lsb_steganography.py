...
def encode(input_file_path, output_file_path, secret_message):
    ...
    try:
        ...
        # Encode the full bits into the frame bytes    #MOST IMPORTANT ENCODING MESSAGE LINE
...
def decode(input_file_path):
    ...
    try:
        ...
        message_bits = ''.join([str((frame_bytes[i + 32] & 1)) for i in range(message_length)])   #MOST IMPORTANT EXTRACTING MESSAGE LINE
